...
plot(airquality$Ozone, airquality$Wind, col='red', main="Ozone vs Wind")
...
mtcars$gear <- factor(mtcars$gear,levels=("3gears","4gears","5gears"),
                      labels=c(3,4,5))
...
ggplot(data=sormas_clean, mapping = aes(x=age, fill=sex)) +geom_histogram()+facet_wrap(~sex)
hist(x,xlab(Hello),ylab="hell",main="hello", xlim(0,20),ylim(0,40))
